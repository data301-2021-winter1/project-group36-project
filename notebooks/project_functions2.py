...
def main():
    ...
    iso_data = column_name_selection(renamed_data)

    geog_data = region_organizer(iso_data)
...
def missing_data_filler(data):
    ...
    filled_data = data.replace('*', 'NaN')
    filled_data = filled_data.replace('.', 'NaN')
    filled_data = filled_data.replace(' ', 'NaN')
    
    return filled_data

def eda_regional(data):
    ...
    yrvalues = [2006, 2007, 2008, 2009, 2010, 2011, 2012]
    ...
    data_list = [data06, data07, data08, data09, data10, data11, data12]
